...
**Fecha:** 2026-08-10 · **Commit:** `5998723`
...
| RNF-2.2 | Primera carga comprimida | 241.2 kB | 165.7 kB | 260.0 kB | cumple |
...
| HTML (incluye los scripts en línea) | 31.1 kB |
| CSS en hojas enlazadas | 12.0 kB |
| Imágenes SVG | 56.8 kB |
| **Primera carga** | **165.7 kB** |
