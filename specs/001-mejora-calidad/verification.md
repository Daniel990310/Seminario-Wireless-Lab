...
**Fecha:** 2026-09-22 · **Commit:** `1ddfd25`
...
| RNF-2.2 | Primera carga comprimida | 241.2 kB | 166.3 kB | 260.0 kB | cumple |
...
| HTML (incluye los scripts en línea) | 31.7 kB |
| CSS en hojas enlazadas | 12.0 kB |
| Imágenes SVG | 22.1 kB |
| **Primera carga** | **166.3 kB** |
