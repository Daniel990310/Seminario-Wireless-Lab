...
**Fecha:** 2026-09-25 · **Commit:** `acde2ff`
...
| RNF-2.2 | Primera carga comprimida | 241.2 kB | 172.2 kB | 260.0 kB | cumple |
...
| HTML (incluye los scripts en línea) | 37.6 kB |
| CSS en hojas enlazadas | 12.0 kB |
| Imágenes SVG | 25.1 kB |
| **Primera carga** | **172.2 kB** |
